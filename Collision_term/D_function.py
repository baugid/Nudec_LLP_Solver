...
def D_function(i,j,k,l):
    ...
    if (i >= j) and (k >= l):
        ...
        if (i+j >= k+l) and (i+l>= j+k) and (i <= j+k+l):
            ...
            D1 = 1/2*(j+k+l-i)
            D3 = 1/60*(i**5 - 5*i**3*j**2 + 5*i**2*j**3 - j**5 - 5*i**3*k**2 + 5*j**3*k**2 + 5*i**2*k**3 + 5*j**2*k**3 - k**5 - 5*i**3*l**2 + 5*j**3*l**2 + 5*k**3*l**2 + 5*i**2*l**3 + 5*j**2*l**3 + 5*k**2*l**3 - l**5)
            ...
            D1 = 1/2*(i+j+l-k)
            D3= 1/60*(k**5 - 5*k**3*l**2 + 5*k**2*l**3 - l**5 - 5*k**3*i**2 + 5*l**3*i**2 + 5*k**2*i**3 + 5*l**2*i**3 - i**5 - 5*k**3*j**2 + 5*l**3*j**2 + 5*i**3*j**2 + 5*k**2*j**3 + 5*l**2*j**3 + 5*i**2*j**3 - j**5)
        ...
        if (i+j >= k+l) and (i+k>=j+l) and (i <= j+k+l):
            ...
            D1 =   1/2*(j+k+l-i)
            D3 =   1/60*(i**5 - 5*i**3*j**2 + 5*i**2*j**3 - j**5 - 5*i**3*l**2 + 5*j**3*l**2 + 5*i**2*l**3 + 5*j**2*l**3 - l**5 - 5*i**3*k**2 + 5*j**3*k**2 + 5*l**3*k**2 + 5*i**2*k**3 + 5*j**2*k**3 + 5*l**2*k**3 - k**5)
            D2_34 = 1/12*((i - j)**3 + 2*(k**3 + l**3) - 3*(i - j)*(k**2 + l**2))
            D2_12 = 1/12*(-(k + l)**3 - 2*i**3 + 2*j**3 + 3*(k + l)*(i**2 + j**2))
            D2_13 = 1/12*(-(j + l)**3 - 2*i**3 + 2*k**3 + 3*(j + l)*(i**2 + k**2))
            D2_14 = 1/12*(-(j + k)**3 - 2*i**3 + 2*l**3 + 3*(j + k)*(i**2 + l**2))
            ...
            D1 = 1/2*(i+j+k-l)
            D3 =   (1/60)*(l**5 - 5*l**3*k**2 + 5*l**2*k**3 - k**5 - 5*l**3*i**2 + 5*k**3*i**2 + 5*l**2*i**3 +5*k**2*i**3 - i**5 - 5*l**3*j**2 + 5*k**3*j**2 + 5*i**3*j**2 + 5*l**2*j**3 + 5*k**2*j**3 + 5*i**2*j**3 - j**5)
        ...
        if (i+j >= k+l) and (j+l >= i+k) and (j <= i+k+l):
            ...
            D1 =   (1/2)*(i+k+l-j)
            D3 =   (1/60)*(j**5 - 5*j**3*i**2 + 5*j**2*i**3 - i**5 - 5*j**3*k**2 + 5*i**3*k**2 + 5*j**2*k**3 + 5*i**2*k**3 - k**5 - 5*j**3*l**2 + 5*i**3*l**2 + 5*k**3*l**2 + 5*j**2*l**3 + 5*i**2*l**3 + 5*k**2*l**3 - l**5)
            ...
            D1 = (1/2)*(i+j+l-k)
            D3 = (1/60)*(k**5 - 5*k**3*l**2 + 5*k**2*l**3 - l**5 - 5*k**3*j**2 + 5*l**3*j**2 + 5*k**2*j**3 +5*l**2*j**3 - j**5 - 5*k**3*i**2 + 5*l**3*i**2 + 5*j**3*i**2 + 5*k**2*i**3 + 5*l**2*i**3 + 5*j**2*i**3 - i**5)
            D2_34 = (1/12)*(-(i + j)**3 - 2*k**3 + 2*l**3 + 3*(i + j)*(k**2 + l**2))
            D2_12 = (1/12)*((k - l)**3 + 2*(i**3 + j**3) - 3*(k - l)*(i**2 + j**2))
            D2_13 = (1/12)*(-(l+j)**3 - 2*k**3 + 2*i**3 + 3*(l+j)*(k**2+i**2))
        ...
        if (i+j >= k+l) and (j+k >= i+l) and (j <= i+k+l):
            ...
            D1 = (1/2)*(i+k+l-j)
            D3 = (1/60)*(j**5 - 5*j**3*i**2 + 5*j**2*i**3 - i**5 - 5*j**3*l**2 + 5*i**3*l**2 + 5*j**2*l**3 + 5*i**2*l**3 - l**5 - 5*j**3*k**2 + 5*i**3*k**2 + 5*l**3*k**2 + 5*j**2*k**3 + 5*i**2*k**3 + 5*l**2*k**3 - k**5)
            D2_34 = (1/12)*((j - i)**3 + 2*(k**3 + l**3) - 3*(j - i)*(k**2 + l**2))
            D2_12 = (1/12)*(-(k + l)**3 - 2*j**3 + 2*i**3 + 3*(k + l)*(i**2 + j**2))
            D2_13 = 1/12*((j - l)**3 + 2*(i**3 + k**3) - 3*(j - l)*(i**2 + k**2))
            D2_14 = (1/12)*((j - k)**3 + 2*(i**3 + l**3) - 3*(j - k)*(i**2 + l**2))
            ...
            D1 = (1/2)*(i+j+k-l)
            D3 = (1/60)*(l**5 - 5*l**3*k**2 + 5*l**2*k**3 - k**5 - 5*l**3*j**2 + 5*k**3*j**2 + 5*l**2*j**3 +5*k**2*j**3 - j**5 - 5*l**3*i**2 + 5*k**3*i**2 + 5*j**3*i**2 + 5*l**2*i**3 + 5*k**2*i**3 + 5*j**2*i**3 - i**5)
